    ...
    return (
        <>
            <View style={{ flex: 1, marginTop: Spacing.BigGap * 2 }}>
                <>
                    <Text style={[TextStyles.h2, { marginBottom: Spacing.BigGap, marginTop: props.currentValues ? 0 : Spacing.BigGap }]}>{ props.currentValues ? 'Edit Account Infomation' : 'Account Infomation'}</Text>
                    <TextField
